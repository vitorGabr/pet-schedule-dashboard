...
import { AppointmentModalSkeleton } from "./appointment-modal-skeleton";
...
export const AppointmentModal = ({
	...
	const currentStatus = appointment
		? appointmentStatusModalOptions[appointment.status]
		: null;
	const handleStatusChange = (status: NextStatus) => setNextStatus(status);

	return (
		<Dialog open={open} onOpenChange={onClose}>
			<DialogContent className="w-3xl px-0 py-0 gap-0">
				{isLoading || !appointment ? (
					...
					<>
						...
						{/* Appointment Details */}
						<div className="space-y-6 max-h-[80vh] overflow-y-auto box-border py-4 px-4">
