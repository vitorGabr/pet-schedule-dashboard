...
export function ActivateServiceModal({ service, onClose }: ActivateServiceModalProps) {
                ...
                <div className="space-y-4">
                    <div className="rounded-lg border bg-muted/50 p-4">
                        ...
                        <div className="flex items-center gap-4 text-sm">
                            <div className="flex items-center gap-1">
                                ...
                                <span className="font-medium">{formatCurrency(service.price / 100)}</span>
                            </div>
                            <div className="flex items-center gap-1">
                    ...
                    <div className="rounded-lg bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 p-3">
                        <p className="text-sm text-green-800 dark:text-green-200">
                            <strong>Observação:</strong> Ao ativar este serviço, ele ficará disponível para novos agendamentos imediatamente.
                        </p>
                    </div>
                </div>
